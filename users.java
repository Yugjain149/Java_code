...
{
	Label lblTitle, lblrollno, lblName, lblCity, lblm1, lblStatus;
	TextField txtName, txtrollno, txtCity, txtm1;
	...
	//Database Connection
		public void connect() {
			...
			{	
					...
					Connection con=DriverManm1r.getConnection("jdbc:mysql://localhost:3306/yug?characterEncoding=latin1","root","1234");  
	...
	public UserFrame() {
		...
		this.setTitle("User Manm1ment System");
		this.setLayout(null);
		...
		lblTitle = new Label("User Manm1ment System");
